...
namespace TestProgrammingSchad.Controllers
{
    public class InvoicesController : Controller
    {
        ...
        {
            var test_InvoiceContext = _context.Invoices.Include(i => i.Customer);
        ...
        public async Task<IActionResult> Create([Bind("Id,CustomerId,TotalItbis,SubTotal,Total")] Invoice invoice)
        {
            if (ModelState.IsValid)
            {
                ...
                return RedirectToAction("Create", "InvoiceDetails", new { invoice.Id});
            }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var invoice = await _context.Invoices.Include(x=>x.InvoiceDetails).FirstOrDefaultAsync(x=>x.Id == id);
            if (invoice == null)
            {
                return NotFound();
            }
